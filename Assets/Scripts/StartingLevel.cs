...
public class StartingLevel : Level
{
    ...
    public StartingLevel()
    {
        ...
        panelText = "This tutorial will show you the basics of two-handed interactions in the Hololens 2. " +
        ...
        panelText2 = "You must use two hands to interact with the panel. If your air tap was not registered, the cursor will remain a hollow circle instead of " +
